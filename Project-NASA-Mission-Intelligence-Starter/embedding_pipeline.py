...
self.collection = self.chroma_client.get_or_create_collection(
    ...
    Ensures chunks do not exceed self.chunk_size and applies self.chunk_overlap.
    """
    ...
    # Replace mode: delete existing chunks from this source file first
